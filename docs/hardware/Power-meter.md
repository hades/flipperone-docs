...
::Image[]{src="/files/pics/flipper-one-power-meter-battery-only.jpg" size="80" position="center" caption="The device is powered only by the battery and is discharging"}
