...
<table isTableHeaderOn="true" columnWidths="[object Object]">
  ...
  <tr>
    <td align="center">
      <p><strong>Hardware Reboot </strong></p>
    </td>
    <td align="left">
  ...
  <tr>
    ...
    <td align="left">
      <p>Hold <code>Power</code> button for N seconds to turn ON device from Power OFF. How long? </p>
  ...
  <tr>
    ...
    <td align="left">
      <p>Hold <code>Power</code> button for 30 seconds to complety turn OFF the device. Whole board will be disconnected from battery and only charger leave powered.</p>
    </td>
  </tr>
  <tr>
    <td align="center" colSpan="1" rowSpan="1">
...
<table isTableHeaderOn="true" columnWidths="[object Object]">
  ...
  <tr>
    ...
    <td>
      ...
      <p><strong>Charging:</strong> PD Sink/Source, 5v-24v</p>
    </td>
  </tr>
  <tr>
    <td align="center">
  ...
  <tr>
    ...
    <td colSpan="1" rowSpan="1">
      <p>Each port uses RTL8211F-CG PHY:
      1G Full-duplex (1G up, 1G down).
      Standards: 1000Base-T,  100Base-TX, , 10Base-T.
      Features: WOL, Auto-Negotiation, Crossover Detection</p>
    </td>
  </tr>
  <tr>
    <td align="center" colSpan="1" rowSpan="1">
  ...
  <tr>
    ...
    <td colSpan="1" rowSpan="1">
      ...
      <p></p><div>Schematic</div><p></p>
      <p>It has an SWD interface SoC for debugging, but it is only active if SD_DET is high. For debugging, you need to use a board with a special cutout. </p><div>Example</div><p></p>
    </td>
  </tr>
  <tr>
    <td align="center" colSpan="1" rowSpan="1">
  ...
  <tr>
    ...
    <td colSpan="1" rowSpan="1">
      ...
      <p>In the connector:
      On the MCU side: RST, SWD, UART, 2xGPIO (the same GPIOs as in the GPIO Connector: 40, 41)
      On the SoC side: RST, UART, 2xGPIO
      *SoC SWD is located in the MicroSD connector</p>
      <p></p><div>Schematic</div><p></p>
      <p>TODO: better name</p>
    </td>
    <td>
