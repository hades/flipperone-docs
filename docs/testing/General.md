...
This builds are made for several RK3576-based single board computers: Radxa 4D, ArmSom Sige5, EVB1, Omni3576

- Build scripts https://github.com/flipperdevices/rk3576-linux-build
- Read to use images https://dl-linux-images.flipp.dev/full-img/
...
- `4K-USB-DisplayPort` — Same as Default boot target, but with USB-C DisplayPort routed to main video out `(vo0)` so should support 4K\@120. HDMI is routed to second `(vo2)` and only support 1080p.
