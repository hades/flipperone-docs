...
:::::WorkflowBlock
:::WorkflowBlockItem
Bring up an access point and connect to an external access point as a client, both on the same channel.
:::

:::WorkflowBlockItem
Confirm both interfaces stay associated simultaneously.
:::

:::WorkflowBlockItem
Measure throughput on each interface with `iperf3`.
:::
:::::
...
:::WorkflowBlockItem
Connect to your freshly created SSID `FlipperOne` with your phone/laptop and check the network connectivity.
:::
:::::
