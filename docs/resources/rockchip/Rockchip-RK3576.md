...
updatedAt: Tue Apr 28 2026 13:29:39 GMT+0000 (Coordinated Universal Time)
---
...
In maskrom mode, when the miniloader is not loaded in RAM, the device does not print anything in the UART.

How to find a maskrom device via `lsusb`:
